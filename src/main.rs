...
fn main() {
    let matches = App::new("BackupApplicator")
        .version(crate_version!())
        .author("covers1624, https://github.com/covers1624")
        .about("Restores MinecraftServer backups generated by FTB Backups & others.")
        .arg(
            Arg::with_name("instance")
                .short("i")
                .long("instance")
                .value_name("FOLDER")
                .help("The instance folder to apply the backup to.")
                .required(true)
                .takes_value(true)
        )
        .arg(
        ...
        .arg(
            Arg::with_name("verbose")
                ...
                .long("verbose")
                .multiple(true)
                .help("Enables verbose logging, can be provided multiple times for increasingly verbose logging.")
        )
        .get_matches();
